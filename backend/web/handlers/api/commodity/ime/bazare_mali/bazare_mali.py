...
class CommodityImeBazareMaliHandler:
    ...
    def handle_request(self, request: Request):
        ...
        if self.authenticator.authorized:
            ...
            bazare_mali_list = self.imeService.get_bazare_mali(sort_by=sort_by, sort_order=sort_order)

            data = [bazare_mali.to_dict() for bazare_mali in bazare_mali_list]
