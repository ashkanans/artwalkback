...
class TestCodalSymbols(TestCase):
    def setUp(self):
    ...
    def test_get_stocks_info(self):
        response = self.client.post('/api/codal/symbols',
                                    json={},
    ...
    def test_get_stocks_info_with_sort_args(self):
        response = self.client.post('/api/codal/symbols?sort=National_Code:desc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
