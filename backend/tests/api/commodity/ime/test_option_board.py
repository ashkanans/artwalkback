...
class TestImeOptionBoard(TestCase):
    def setUp(self):
    ...
    def test_get_ime_option_board(self):
        response = self.client.post('/api/commodity/ime/option_board',
                                    json={},
    ...
    def test_get_sorted_ime_option_board(self):
        response = self.client.post('/api/commodity/ime/option_board?sort_by=ActiveBrokers&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["ActiveBrokers"] <= response_last_element["ActiveBrokers"])
