...
class TestImeExport(TestCase):
    ...
    def test_get_ime_export(self):
        response = self.client.post('/api/commodity/ime/export',
                                    json={},
    ...
    def test_get_sorted_ime_export(self):
        response = self.client.post('/api/commodity/ime/export?sort_by='
                                    '&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
