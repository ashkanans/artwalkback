...
class TestImeGold(TestCase):
    ...
    def test_get_ime_gold(self):
        response = self.client.post('/api/commodity/ime/gold',
                                    json={},
    ...
    def test_get_sorted_ime_gold(self):
        response = self.client.post('/api/commodity/ime/gold?sort_by=ActiveCustomers&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["ActiveCustomers"] <= response_last_element["ActiveCustomers"])
