...
class TestImeBazareMali(TestCase):
    def setUp(self):
    ...
    def test_get_bazare_mali(self):
        response = self.client.post('/api/commodity/ime/bazare_mali',
                                    json={},
        ...
        expected_keys = [
            ...
            "DT_En",
            "LVal18AFC",
            "LastPriceChangePrice",
            "LastPriceChangePricePercent",
            "LastTradeChangePrice",
            "LastTradeChangePricePercent",
            "Namad",
            "NamadDescription",
            "PClosing",
            "PDrCotVal",
    ...
    def test_get_sorted_ime_bazare_mali(self):
        response = self.client.post('/api/commodity/ime/bazare_mali?sort_by=NamadDescription&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["NamadDescription"] <= response_last_element["NamadDescription"])
