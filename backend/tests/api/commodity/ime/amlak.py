...
class TestImeAmlak(TestCase):
    ...
    def test_get_amlak(self):
        response = self.client.post('/api/commodity/ime/amlak',
                                    json={},
    ...
    def test_get_sorted_ime_amlak(self):
        response = self.client.post('/api/commodity/ime/amlak?sort_by=ArzehKonandeh&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
    ...
    def test_get_sorted_amlak(self):
        response = self.client.post('/api/commodity/ime/amlak',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
