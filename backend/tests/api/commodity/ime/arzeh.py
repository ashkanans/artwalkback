...
class TestImeArzeh(TestCase):
    ...
    def test_get_arzeh(self):
        response = self.client.post('/api/commodity/ime/arzeh',
                                    json={},
        ...
        expected_keys = ["ArzehKonandeh",
                         ...
                         "Talar",
                         "Unit",
                         "bArzehRadifAndazehMahmuleh",
                         "bArzehRadifArzeh",
                         "bArzehRadifArzehAvalieh",
                         "bArzehRadifArzehSharh",
                         "bArzehRadifBuyMethod",
                         "bArzehRadifDarsad",
                         "bArzehRadifKashfNerkhMinBuy",
                         "bArzehRadifMab",
                         "bArzehRadifMaxBasePrice",
                         "bArzehRadifMaxKharidM",
                         "bArzehRadifMaxMab",
                         "bArzehRadifMaxMahmooleh",
                         "bArzehRadifMinArzeh",
                         "bArzehRadifMinMab",
                         "bArzehRadifMinMahmooleh",
                         "bArzehRadifMinTakhsis",
                         "bArzehRadifMode",
                         "bArzehRadifMojazTahvilMinTel",
                         "bArzehRadifNamadKala",
                         "bArzehRadifPK",
                         "bArzehRadifShekl",
                         "bArzehRadifSize",
                         "bArzehRadifStatusSharh",
                         "bArzehRadifSumBuyOrders",
                         "bArzehRadifTarTahvil",
                         "bArzehRadifTasviehTypeID",
                         "bArzehRadifTasviehTypeSharh",
                         "bArzehRadifTedadMahmooleh",
                         "bArzehRadifTikSize",
                         "bArzehRadifVahedAndazegiri",
                         "bArzehRadifZaribMahmooleh",
                         "bArzehTarArzeh",
                         "cBrokerSpcName",
                         "id",
                         "xContractKindSharh",
                         "xKalaNamTejari",
                         "xKalaNamadKala",
                         "xKala_xGrouhAsliKalaPK",
                         "xKala_xGrouhKalaPK",
                         "xKala_xZirGrouhKalaPK",
                         "xMahalTahvilSharh",
                         "xTolidKonandehPK",
                         "xTolidKonandehSharh",
                         ]
    ...
    def test_get_sorted_ime_arzeh(self):
        response = self.client.post('/api/commodity/ime/arzeh?sort_by=ArzehKonandeh&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["ArzehKonandeh"] <= response_last_element["ArzehKonandeh"])
