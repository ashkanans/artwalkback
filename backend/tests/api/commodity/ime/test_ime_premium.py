...
class TestImePremium(TestCase):
    ...
    def test_get_ime_premium(self):
        response = self.client.post('/api/commodity/ime/premium',
                                    json={},
    ...
    def test_get_sorted_ime_premium(self):
        response = self.client.post('/api/commodity/ime/premium?sort_by=GoodsName&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
