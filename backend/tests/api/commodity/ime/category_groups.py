...
class TestImeCategoryGroups(TestCase):
    def setUp(self):
    ...
    def test_get_category_groups(self):
        response = self.client.post('/api/commodity/ime/category_groups',
                                    json={},
    ...
    def test_get_sorted_category_groups(self):
        response = self.client.post('/api/commodity/ime/category_groups?sort_by=name&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
