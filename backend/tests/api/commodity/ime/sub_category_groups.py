...
class TestImeSubCategoryGroups(TestCase):
    def setUp(self):
    ...
    def test_get_sub_category_groups(self):
        response = self.client.post('/api/commodity/ime/sub_category_groups',
                                    json={},
    ...
    def test_get_sorted_ime_sub_category_groups(self):
        response = self.client.post('/api/commodity/ime/sub_category_groups?sort_by=name&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["name"] <= response_last_element["name"])
