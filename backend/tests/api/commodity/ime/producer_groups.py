...
class TestImeProducerGroups(TestCase):
    def setUp(self):
    ...
    def test_get_producer_groups(self):
        response = self.client.post('/api/commodity/ime/producer_groups',
                                    json={},
    ...
    def test_get_sorted_producer_groups(self):
        response = self.client.post('/api/commodity/ime/producer_groups?sort_by=name&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
