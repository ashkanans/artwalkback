...
class TestImeCurrency(TestCase):
    def setUp(self):
    ...
    def test_get_currency(self):
        response = self.client.post('/api/commodity/ime/currency',
                                    json={},
    ...
    def test_get_sorted_ime_currency(self):
        response = self.client.post('/api/commodity/ime/currency?sort_by=acrynom&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["acrynom"] <= response_last_element["acrynom"])
