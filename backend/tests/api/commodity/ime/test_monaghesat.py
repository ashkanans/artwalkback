...
class TestImeMonaghesat(TestCase):
    def setUp(self):
    ...
    def test_get_ime_monaghesat(self):
        response = self.client.post('/api/commodity/ime/monaghesat',
                                    json={},
    ...
    def test_get_sorted_ime_monaghesat(self):
        response = self.client.post('/api/commodity/ime/monaghesat?sort_by=GoodsName&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
        ...
        self.assertTrue(response_first_element["GoodsName"] <= response_last_element["GoodsName"])
