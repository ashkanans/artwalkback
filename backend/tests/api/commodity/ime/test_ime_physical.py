...
class TestImePhysical(TestCase):
    def setUp(self):
    ...
    def test_get_ime_physical(self):
        response = self.client.post('/api/commodity/ime/physical',
                                    json={},
    ...
    def test_get_sorted_ime_physical(self):
        response = self.client.post('/api/commodity/ime/physical?sort_by=GoodsName&sort_order=asc',
                                    json={},
                                    headers={'Authorization': "Bearer " + self.token})
